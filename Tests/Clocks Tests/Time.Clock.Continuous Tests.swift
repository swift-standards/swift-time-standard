// Time.Clock.Continuous Tests.swift
// Clocks Tests
...
extension Time.Clock.Continuous.Test.Unit {
    ...
    func staticNowMatchesInstance() {
        ...
        let staticNow = Time.Clock.Continuous.Instant.now
    ...
    func conformsToClock() async throws {
        let clock: any Clock = Time.Clock.Continuous()
        _ = clock.now
...
extension Time.Clock.Continuous.Test.EdgeCase {
    ...
    func sleepWithPastDeadline() async throws {
        ...
        // Should complete almost immediately (not wait 10 seconds)
    ...
    func multipleClocksShareTime() {
        let clock1 = Time.Clock.Continuous()
        let clock2 = Time.Clock.Continuous()
        let now1 = clock1.now
        let now2 = clock2.now
...
extension Time.Clock.Continuous.Test.Performance {
